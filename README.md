...
### Dashboard Overview
Real-time energy flow visualization with weather data, solar production, battery status, and grid interaction.

![Dashboard Overview](images/sfml-02.png)

### Production Analytics
Detailed charts showing actual vs. forecasted solar production with accuracy metrics and individual panel group performance.

![Production Analytics](images/sfml-01.png)
